<?php
/**
 * Contains Wpvr_Pro_Dependency_Check class. and wps_extend_plugins function.
 *
 * @package    WPS_Core
 ...
 */
if ( !class_exists('Wpvr_Pro_Dependency_Check') ) {
    /**
     * Class Rx_Sb_Pro_Dependency_Check
     *
     ...
     *
     */
    class Wpvr_Pro_Dependency_Check {
        /**
        ...
        private function set_message( $type ) {
            ...
            switch ( $type ) {
                ...
                default:
                    ...
                    $this->message = sprintf(
                        __( 'Please Install & Activate the free version of WPVR (%s) before activating WPVR Pro.', $this->text_domain ),
                        $this->min_version,
                        $action
                    );
                    break;
        ...
        public static function deactivate_self( $file, $network_wide = false ) {
            if ( is_multisite() && false !== $network_wide ) {
                $network_wide = is_plugin_active_for_network( 'wpvr-pro/wpvr-pro.php' );
            }
